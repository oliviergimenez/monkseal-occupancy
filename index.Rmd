...
A few sites are really small, more precisely `r round(mean(as.numeric(grid$areakm2)<10))` percent of the `r nrow(grid)` (i.e. `r sum(as.numeric(grid$areakm2)<10)` sites) are less than $10km^2$.
